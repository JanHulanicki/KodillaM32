...
public class TrelloControllerTest {
    ...
    public void shouldCreateTrelloCard() throws Exception {
        ...
        CreatedTrelloCartDto createdTrelloCartDto = new CreatedTrelloCartDto("323", "Test", "http://test.com");
        when(trelloFacade.createCard(ArgumentMatchers.any(TrelloCardDto.class))).thenReturn(createdTrelloCartDto);
        Gson gson = new Gson();
